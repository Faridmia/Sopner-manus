                ...
                <div class="col-lg-6 col-md-6">
                    <form class="form-horizontal" action="#" method="POST" id="add">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="cat_name" name='b_name' value=""/>
                            </div>
                          </div>
                            <div class="form-group">
                                <div id="success"></div>
                          ...
                          <div class="form-group">
                              <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <?php echo $database->formtoken();?>
                                    <button type="submit" name="submit" value='submit' class="btn btn-primary btn-lg">Add Brand<span class="glyphicon glyphicon-ok-sign"></span></button>
                             </div>
                        </div>
                    </form>
                </div>          
